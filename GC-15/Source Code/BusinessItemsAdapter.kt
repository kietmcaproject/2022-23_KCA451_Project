...
class BusinessItemsAdapter : RecyclerView.Adapter<BusinessItemsAdapter.ViewHolder> {
    ...
    constructor(
        ...
        this.clickEvent = categoryBusinessDetailsFragment
    }
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        if (businessItems!![position].noOfBrandsInStock > 0) {
