...
class CouponsGroceryAdapter : RecyclerView.Adapter<CouponsGroceryAdapter.ViewHolder> {
...
//        this.clickEvent = placeOrderFragment
    }
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, position: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.custom_coupon_layout, viewGroup, false))
    }
