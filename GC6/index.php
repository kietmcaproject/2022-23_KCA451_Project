         ...
         <?php include_once('includes/header.php');?>
                ...
                <div class="slider-container slider-02 bg-overlay">
                    ...
                    <div id="mainSlider" class="nivoSlider slider-image"> 
                        <img src="img/event-management-system2.jpg" alt="event-management-system" title="#htmlcaption1" height="200" /> 
                    </div>
                </div>
                <!--slider area are End-->
                              ...
                              <div class="single-upcomming shadow-box">
                                 ...
                                 <div class="col-md-3 col-sm-5 col-xs-12">
                                    <div class="uc-event-title">
                                        ...
                                        <a href="event-details.php?evntid=<?php echo htmlentities($row->id);?>"><?php echo htmlentities($row->EventName);?></a>
