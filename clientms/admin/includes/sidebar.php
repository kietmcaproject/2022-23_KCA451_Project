...
{               ?>
    ...
    <div class="menu">
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Queries</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="add-services.php"> Add Queries</a></li>
                    <li id="menu-academico-boletim" ><a href="manage-services.php">Manage Queries</a></li>
            ...
            <li><a href="invoices.php"><i class="fa fa-file-text-o"></i> <span>Queries</span></a></li>
            ...
            <li><a href="search-invoices.php"><i class="fa fa-search"></i> <span>Search Queries</span></a></li>
