...
<html>
<head>
	<title>Customer Query Management Sysytem || Search Queries </title>
...
<body>
				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active">Search Queries</li>
						</ol>
					</div>
					<!--//sub-heard-part-->
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Search Queries </h3>
						<div class="graph">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Search by Query ID or Billing Number</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
