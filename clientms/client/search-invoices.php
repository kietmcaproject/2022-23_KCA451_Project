...
<body>
			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Search Query </h3>
						<div class="graph">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Search by Query Number or Billing Number</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
